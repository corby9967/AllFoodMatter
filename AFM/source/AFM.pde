...
void loading(){
  ...
  fill(255);
  textFont(font);
  text("Washing Dishes...", 145, -30 + height - j/1.5);// 글자1 등속도 이동 (위로)
  text("Making my Bed...", 146, -30 + height - j/1.5 + 60);// 글자2 등속도 이동 (위로)
  text("Playing Guitar...", 153, -30 + height - j/1.5 + 120);// 글자3 등속도 이동 (위로)
  text("Ready to Go!", 163, -30 + height - j/1.5 + 167);// 글자4 등속도 이동 (위로)
...
void tournament(){
  ...
  if(page_ == 0){
    ...
    if((mouseX >= 0 && mouseX <= 435) && (mouseY >= 129 && mouseY <= 477) && (page == 3.1 || page == 3.2 || page == 3.3 || page == 4.1 || page == 4.2 || page == 4.3 || page == 4.4)){
        flag = 1;
    }
